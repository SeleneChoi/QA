    ...
    <main id="top">
        <div class="purple1">
            ...
            <div class="purple2 grid grid-cols-2 lg:grid-cols-12 gap-6 p-5 py-10 lg:p-6">
                ...
                <div class="col-span-full lg:col-span-4 flex flex-col">
                    <img class="mb-2 rounded" src="./images/profile/henry_profile.png" alt="person1">
                    <div class="flex flex-row justify-between">
                        <div class="flex flex-col justify-around">
                ...
                <div class="col-span-full lg:col-span-4 flex flex-col">
                    <img class="mb-2 rounded" src="./images/profile/selene_profile.png" alt="person1">
                    <div class="flex flex-row justify-between">
                        <div class="flex flex-col justify-around">
                ...
                <div class="col-span-full lg:col-span-4 flex flex-col">
                    <img class="mb-2 rounded" src="./images/profile/johann_profile.png" alt="person1">
                    <div class="flex flex-row justify-between">
                        <div class="flex flex-col justify-around">
                ...
                <div class="col-span-full lg:col-span-4 flex flex-col">
                    <img class="mb-2 rounded" src="./images/profile/christine_profile.png" alt="person1">
                    <div class="flex flex-row justify-between">
                        <div class="flex flex-col justify-around">
                ...
                <div class="col-span-full lg:col-span-4 flex flex-col">
                    <img class="mb-2 rounded" src="./images/profile/nicola_profile.png" alt="person1">
                    <div class="flex flex-row justify-between">
                        <div class="flex flex-col justify-around">
